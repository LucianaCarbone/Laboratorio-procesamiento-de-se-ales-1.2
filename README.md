...
### Parte B
1. **Generación:** Se generó una señal electrocardiográfica utilizando un generador de señales biológicas.
...
4. **Visualización en Python:** En el computador se ejecutó el archivo de la interfaz gráfica, el cual:
